...
import postToCloudinary from "../../helpers/postToCloudinar";
...
const Reply = ({ props, profile, ownProfile, setIsOpenParentModal }) => {
  ...
  const [commentAltText, setCommentAltText] = useState(
    generateAltText(ownProfile.displayName),
  );
    ...
    },
    {
      ...
      item: (
        <AddALT
          ...
          setCommentAltText={setCommentAltText}
        />
      ),
    },
  ];
      ...
      <div className="reply">
        <Timeline>
          ...
          <TimelineItem>
            ...
            <TimelineContent>
              <form onSubmit={sendComment} className="tweetBox__input__form">
